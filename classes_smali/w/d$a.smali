...
.method public constructor <init>(C[F)V
    ...
    .line 2
    iput-char p1, p0, Lw/d$a;->a:C

    .line 3
    iput-object p2, p0, Lw/d$a;->b:[F
...
.method public constructor <init>(Lw/d$a;)V
    ...
    .line 5
    iget-char v0, p1, Lw/d$a;->a:C

    iput-char v0, p0, Lw/d$a;->a:C

    .line 6
    iget-object p1, p1, Lw/d$a;->b:[F

    array-length v0, p1

    const/4 v1, 0x0

    invoke-static {p1, v1, v0}, Lw/d;->b([FII)[F

    move-result-object p1

    iput-object p1, p0, Lw/d$a;->b:[F
...
.method public static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    .line 11
    invoke-static/range {v0 .. v9}, Lw/d$a;->a(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static b([Lw/d$a;Landroid/graphics/Path;)V
    .registers 32
    ...
    if-ge v10, v2, :cond_3d5

    .line 2
    aget-object v2, v0, v10

    iget-char v9, v2, Lw/d$a;->a:C

    aget-object v2, v0, v10

    iget-object v8, v2, Lw/d$a;->b:[F
    ...
    sparse-switch v9, :sswitch_data_3d6
    ...
    if-eq v9, v15, :cond_319

    const/16 v15, 0x51

    if-eq v9, v15, :cond_2f3

    const/16 v12, 0x56

    if-eq v9, v12, :cond_2df

    const/16 v12, 0x61

    if-eq v9, v12, :cond_28b

    const/16 v12, 0x63

    if-eq v9, v12, :cond_24f

    const/16 v2, 0x68

    if-eq v9, v2, :cond_23e

    const/16 v2, 0x71

    if-eq v9, v2, :cond_219

    const/16 v12, 0x76

    if-eq v9, v12, :cond_206
    ...
    if-eq v9, v15, :cond_18a

    const/16 v15, 0x74

    const/16 v2, 0x54

    if-eq v9, v2, :cond_153

    const/16 v2, 0x6c

    if-eq v9, v2, :cond_13c

    if-eq v9, v14, :cond_114
    ...
    invoke-static/range {v1 .. v10}, Lw/d$a;->a(Landroid/graphics/Path;FFFFFFFZZ)V
